/* ==========================================================================
   [모듈] PWA 서비스 워커 (assets/pwa/service-worker.js)
   [역할]
   - 앱 정적 파일과 지도 타일을 캐싱해 오프라인 사용성과 재방문 속도를 높입니다.
   - 앱 기본 자원은 네트워크 우선, 지도 타일은 캐시 우선 전략으로 처리합니다.
   [참고]
   - 캐시 이름, 오프라인 동작, 서비스 워커 업데이트 정책을 바꿀 때 확인합니다.
   ========================================================================== */
const STATIC_CACHE_NAME = 'F-field-v1.0.9';
